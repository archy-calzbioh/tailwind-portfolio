...
export const meta = {
  ...
  description:
    ' Cutting-edge technology is much more accessible with the aid of Google Colab iPython notebooks. Google Colab is a free online platform that allows you to run Python code in your browser. This makes it easy to experiment with stable diffusions and other machine learning models.',
}
